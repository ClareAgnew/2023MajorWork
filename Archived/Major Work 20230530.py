...
#Functional Test, player can stand on all obstacles, but cannot go through them
...
def Game():
    ...
    global screen1obstacle1, screen1obstacle2, screen1obstacle3, screen1obstacle4, screen2obstacle1, screen2obstacle2, screen2obstacle3, screen2obstacle4, screen3obstacle1, screen3obstacle2, screen3obstacle3, screen3obstacle4, screen3obstacle1, screen3obstacle2, screen3obstacle3, screen3obstacle4, screen4obstacle1, screen4obstacle2, screen4obstacle3, screen4obstacle4
    (x, y) = (0, 0)
    screeny = 0
    vel = 5
    man.x = 100
