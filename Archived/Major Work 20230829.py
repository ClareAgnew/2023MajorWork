...
#User Interface Test, Replaced placeholder platform image with a separate, more suitable image
#Performance Test, Fixed issue resulting in events only partially being detected
...
obstacleImageWidth = pygame.image.load("Platform1.png").get_width()/10
obstacleImageHeight = pygame.image.load("Platform1.png").get_height()/10
obstacleImage = pygame.transform.scale(obstacle, (obstacleImageWidth, obstacleImageHeight))
...
def Game():
    ...
    global MenuHelp, game_over, mainGame, Help, Home, Menu, platform, Died
    while not game_over and not Help and not Home:
        ...
        while Screens >= 1 and not game_over and not Home:
            ...
            if Screen1 and not game_over:
                ...
                if man.isJump:
                    if (Screen1pos1 + obstacle1x + obstacleImage.get_width() > man.x > Screen1pos1 + obstacle1x or Screen1pos1 + obstacle1x + obstacleImage.get_width() > man.x + playerWidth > Screen1pos1 + obstacle1x or Screen1pos2 + obstacle1x + obstacleImage.get_width() > man.x > Screen1pos2 + obstacle1x or Screen1pos2 + obstacle1x + obstacleImage.get_width() > man.x + playerWidth > Screen1pos2 + obstacle1x or Screen1pos3 + obstacle1x + obstacleImage.get_width() > man.x > Screen1pos3 + obstacle1x or Screen1pos3 + obstacle1x + obstacleImage.get_width() > man.x + playerWidth > Screen1pos3 + obstacle1x or Screen1pos4 + obstacle1x + obstacleImage.get_width() > man.x > Screen1pos4 + obstacle1x or Screen1pos4 + obstacle1x + obstacleImage.get_width() > man.x + playerWidth > Screen1pos4 + obstacle1x):
                        print("character is",man.y+playerHeight, "obstacle is",520-obstacleImageHeight)
                        print(platform)
                        over = True

                if over and man.y + playerHeight > 520 - obstacleImage.get_height():
                        print("y")
            ...
            if Screen2 and not game_over:
                ...
                if 480<=Screen2pos4+obstacle2x <= 520 and Screen2run:
                    Screens -= 1
                    Screen2run = False
            ...
            if Screen3 and not game_over:
                ...
                if 480<=Screen3pos4+obstacle3x <= 520 and Screen3run:
                    Screens -= 1
                    Screen3run = False
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEMOTION:
                    ...
                    if Menu and not MenuHelp and (menu_quit_button_rect[0] <= x <= menu_quit_button_rect[0] + menu_quit_button_rect[2] and
                    ...
                    if Menu and not MenuHelp and (menu_home_button_rect[0] <= x <= menu_home_button_rect[0] + menu_home_button_rect[2] and
                    ...
                    if Menu and not MenuHelp and (menu_help_button_rect[0] <= x <= menu_help_button_rect[0] + menu_help_button_rect[2] and
            ...
            obstacle(Screen1pos1 + obstacle1x, 520 - obstacleImage.get_height()-10, obstacleImage.get_width(),
                     obstacleImage.get_height()).drawObstacle(Screen)
            obstacle(Screen1pos2 + obstacle1x, 520 - obstacleImage.get_height()-40, obstacleImage.get_width(),
                     obstacleImage.get_height()).drawObstacle(Screen)
            obstacle(Screen1pos3 + obstacle1x, 520 - obstacleImage.get_height()-70, obstacleImage.get_width(),
                     obstacleImage.get_height()).drawObstacle(Screen)
            obstacle(Screen1pos4 + obstacle1x, 520 - obstacleImage.get_height()-20, obstacleImage.get_width(),
                     obstacleImage.get_height()).drawObstacle(Screen)
