...
obstacleImage = pygame.image.load("token_2.png")
game = True
    ...
    while game:
        if not Screen1 and not Screen2 and not Screen3 and not Screen4:
            ...
            while Screen1:
                ...
                Screen.blit(obstacleImage, (screen1pos1 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen1pos2 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen1pos3 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen1pos4 + x, 520 - obstacleImage.get_height()))
                man.draw(Screen)
            ...
            while Screen2:
                ...
                Screen2box2_rect[0]) <= -Screen2box2.width and (Screen2box3_rect[0]) <= -Screen2box3.width:
                    ...
                    Screen2 = False
                Screen.blit(playGameImage, (0, 0))
                Screen.blit(obstacleImage, (screen2pos1 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen2pos2 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen2pos3 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen2pos4 + x, 520 - obstacleImage.get_height()))
                man.draw(Screen)
                pygame.display.update()
                #print(62)
                x -= 25
            ...
            while Screen3:
                ...
                Screen3box2_rect[0]) <= -Screen3box2.width and (Screen3box3_rect[0]) <= -Screen3box3.width:
                    ...
                    Screen3 = False
                Screen.blit(playGameImage, (0, 0))
                Screen.blit(obstacleImage, (screen3pos1 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen3pos2 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen3pos3 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen3pos4 + x, 520 - obstacleImage.get_height()))
                man.draw(Screen)
                pygame.display.update()
                #print(62)
                x -= 25
            ...
            while Screen4:
                ...
                Screen4box2_rect[0]) <= -Screen4box2.width and (Screen4box3_rect[0]) <= -Screen4box3.width:
                    ...
                    Screen4 = False
                Screen.blit(playGameImage, (0, 0))
                Screen.blit(obstacleImage, (screen4pos1 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen4pos2+ x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen4pos3 + x, 520 - obstacleImage.get_height()))
                Screen.blit(obstacleImage, (screen4pos4 + x, 520 - obstacleImage.get_height()))
                man.draw(Screen)
                pygame.display.update()
                #print(62)
                x -= 25
